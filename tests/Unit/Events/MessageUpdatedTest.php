...
/**
 * @covers \Konceiver\Inbox\Events\MessageUpdated
 */
class MessageUpdatedTest extends TestCase
{
    /** @test */
    public function it_dispatches_the_event(): void
    {
        ...
        Event::assertDispatched(MessageUpdated::class, fn ($e) => $e->message->id === $message->id);
    }
}
